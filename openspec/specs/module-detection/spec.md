...
### Requirement: Detect child module directories
The system SHALL discover modules by scanning child directories under `modules/` using `builtins.readDir` instead of checking for sibling repositories in the parent directory.
...
### Requirement: Shell banner reports modules
